      ...
      {blocks.map((block, index) => {
        switch (block.blockType) {
          ...
          case 'featureComparison':
            return <FeatureComparisonBlock key={index} {...block} />
          
          case 'callToAction':
            return <CallToActionBlock key={index} {...block} />
          
          case 'emphasis':
            return <EmphasisBlock key={index} {...block} />
          
          case 'contentOverview':
            return <ContentOverviewBlock key={index} {...block} />
          
          case 'conclusion':
            return <ConclusionBlock key={index} {...block} />
