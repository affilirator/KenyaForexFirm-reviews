                      ...
                      <div className="bg-white rounded-b-lg shadow-lg border-x border-b border-gray-200 flex overflow-hidden">
                          ...
                          <div className="grid grid-cols-2 gap-x-8 gap-y-6">
                            {link.subLinks.map((subLink, subIndex) => (
                              <a
                                key={subIndex}
                                href={subLink.href}
                                className="block group/item -m-3 p-3 rounded-lg hover:bg-gray-50 transition-colors"
                              >
                        ...
                        {link.featuredLink && (
                          <div className="w-1/3 bg-gray-50 p-8 border-l border-gray-200">
                            <a
                              href={link.featuredLink.href}
                              className="block -m-3 p-3 rounded-lg hover:bg-gray-100 transition-colors h-full"
                            >
                              <div className="flex items-center justify-center flex-col text-center h-full">
                                ...
                                <div className="mt-4">
                                  <p className="font-semibold text-gray-900">
                                    {link.featuredLink.title}
                                  </p>
                                  <p className="text-sm text-gray-500 mt-1">
                                    {link.featuredLink.description}
                                  </p>
                                </div>
                              </div>
                            </a>
                ...
                {navLinks.map((link, index) =>
                  link.subLinks ? (
                    ...
                    <li key={index}>
                      <a
                        href={link.href}
                        className="block font-semibold py-2 hover:text-gray-900"
                      >
                        {link.title}
                      </a>
                    </li>
