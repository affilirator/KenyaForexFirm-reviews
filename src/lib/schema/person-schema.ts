  ...
  hasCredential: [
    {
      ...
      description:
        'A professional designation for technical analysts, awarded by the CMT Association.',
    ...
    },
    {
      ...
      description:
        'The Chartered Financial Analyst program is a postgraduate professional certification offered internationally by the US-based CFA Institute to investment and financial professionals.',
  ...
  knowsAbout: [
    {
      ...
      name: 'Forex Trading',
      inDefinedTermSet:
        'https://en.wikipedia.org/wiki/Category:Foreign_exchange_market',
    ...
    },
    {
      ...
      inDefinedTermSet:
        'https://en.wikipedia.org/wiki/Category:Technical_analysis',
    ...
    },
    {
      ...
      inDefinedTermSet:
        'https://en.wikipedia.org/wiki/Category:Financial_technical_analysis',
