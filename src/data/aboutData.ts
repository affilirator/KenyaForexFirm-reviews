...
export const coreValues = [
  {
    title: 'Our Mission',
    description:
      'To empower Kenyan traders with comprehensive, unbiased forex broker reviews and educational resources that promote safe and profitable trading.',
    icon: '🎯',
  },
  {
    title: 'Our Vision',
    description:
      'To be the most trusted source of forex broker information in East Africa, setting the standard for transparency and accuracy in financial market analysis.',
    icon: '👁️',
  },
  {
    title: 'Our Values',
    description:
      'Integrity, transparency, accuracy, and independence guide all our reviews. We never accept payment for favorable ratings or reviews.',
    icon: '⚖️',
  },
];
...
export const team = [
  {
    ...
    credentials: 'CFA, FRM',
    education:
      'Masinde Muliro University - Bachelor of Journalism and Mass Communication',
    ...
    avatar:
      'https://fxmedia.kenyaforexfirm.com/Patrick-Mahinge-kenya-forex-firm.webp',
  },
  /*{
    name: "Sylvia Muchai",
  ...
  */
  {
    ...
    avatar:
      'https://fxmedia.kenyaforexfirm.com/edwin-kamau-kenya-forex-firm.jpg',
  },
  {
    name: 'Grace Mutua',
    ...
    education:
      'University of Cape Town - Master of Science in Financial Technology',
    ...
    avatar:
      'https://fxmedia.kenyaforexfirm.com/grace-mutua-kenya-forex-firm.jpg',
  },
  {
    name: 'Peter Mwangi',
    ...
    education:
      'ACCA Professional - Association of Chartered Certified Accountants',
    ...
    avatar:
      'https://fxmedia.kenyaforexfirm.com/peter-mwangi-kenya-forex-firm.jpg',
  },
  {
    name: 'Ann Nyokabi',
    ...
    avatar:
      'https://fxmedia.kenyaforexfirm.com/ann-nyokabi-kenya-forex-firm.jpg',
  },
];
...
export const methodology = [
  {
    ...
    description:
      'We open real trading accounts with minimum deposits and conduct actual trades to test execution, spreads, and withdrawal processes.',
    icon: '💰',
  },
  {
    title: 'Regulatory Verification',
    description:
      'Every broker undergoes thorough regulatory checks including CMA status verification and international license validation.',
    icon: '🔍',
  },
  {
    title: 'Cost Analysis',
    description:
      'Comprehensive analysis of all trading costs including spreads, commissions, swaps, and hidden fees across multiple account types.',
    icon: '📊',
  },
  {
    title: 'Platform Testing',
    description:
      'Hands-on testing of trading platforms for functionality, speed, reliability, and mobile compatibility under different market conditions.',
    icon: '💻',
  },
  {
    title: 'Customer Support Evaluation',
    description:
      'Multi-channel testing of customer support including response times, quality of assistance, and language support for Kenyan clients.',
    icon: '🎧',
  },
  {
    title: 'Continuous Monitoring',
    description:
      'Ongoing monitoring of broker performance, regulatory changes, and market conditions to keep reviews current and accurate.',
    icon: '📈',
  },
];
